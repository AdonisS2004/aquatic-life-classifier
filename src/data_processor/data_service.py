...
class DataService():
    """Client for generating and processing data"""
    def __init__(self):
        pass

    @log(include_timer=True)
    def generate_data(self, root_path: str, data_config_path: str) -> None:
        """
        Args:
    ...
    @log(include_timer=True)
    def process_data(self, path: str, destination: str, new_height: int = 224, new_width: int = 224) -> None:
